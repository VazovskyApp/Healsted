...
import app.vazovsky.healsted.data.model.orDefault
...
class ParseSnapshotToProfileUseCase @Inject constructor() :
    UseCaseUnary<ParseSnapshotToProfileUseCase.Params, Account>() {
