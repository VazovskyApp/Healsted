...
class PillsAdapter @Inject constructor(val dateFormatter: DateFormatter) : BaseAdapter<Pill, PillsViewHolder>() {

    lateinit var onItemClick: (Pill) -> Unit

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PillsViewHolder {
        return PillsViewHolder(parent, onItemClick, dateFormatter)
    }
